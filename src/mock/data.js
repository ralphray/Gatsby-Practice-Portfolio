...
export const projectsData = [
  {
    ...
    info: '       The literal French translation of "Soma" is "playful," which is a fitting term to describe the "boyishly short and sassy hairstyle," says Razza, who points to Audrey Hepburns iconic style as a prime example. Soma also includes the pixie cut, which involves shorn sides and back with longer layers on top.     ',
    info2: '',
